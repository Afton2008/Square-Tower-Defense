...
def inventory_screen():
    ...
    for i, (name, data) in enumerate(page_items):
        ...
        if owned:
            ...
            buttons.append((name, buy_btn, owned, price, is_frost_blast))
        elif is_frost_blast:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            for name, rect, owned, price, is_frost_blast in buttons:
                if rect.collidepoint(mx, my):
                    if is_frost_blast and not owned: show_frost_blast_info_popup()
                    elif not owned and not is_frost_blast:
                        if save["shape"] >= price:
                            save["shape"] -= price
...
def draw_upgrade_ui(screen, tower):
    ...
    # Hitung DPS dengan dan tanpa efek
