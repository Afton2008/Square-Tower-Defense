...
def intro_screen():
    ...
    subtitle = font_mid.render("Version 1.1.0", True, GRAY)  
...
def home_screen():
    ...
    btn_inventory = draw_button("Inventory", WIDTH//2 - 250, 200, 500, 90, mouse_pos)
    btn_story     = draw_button("Story",     WIDTH//2 - 250, 310, 500, 90, mouse_pos)
    btn_event     = draw_button("Event",     WIDTH//2 - 250, 420, 500, 90, mouse_pos)
    btn_history   = draw_button("History",   WIDTH//2 - 250, 530, 500, 90, mouse_pos)
...
class Tower:
    ...
    # Convert detik ke frame (asumsi 60 FPS)
        self.slow_timer = int(duration * 60)
